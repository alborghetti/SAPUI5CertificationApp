sap.ui.define([
	...
	return BaseController.extend("it.interlem.sapui5TrainingTrainingDemo.controller.Orders", {
		...
		onOrderSelection : function (oEvent) {
			...
			this._showOrder(oEvent.getParameter("listItem") || oEvent.getSource());
		},
		...
		/**
		 * Shows the selected order on the detail page
		 * On phones a additional history entry is created
		 * @param {sap.m.ObjectListItem} oItem selected Item
		 * @private
		 */
		_showOrder : function (oItem) {
